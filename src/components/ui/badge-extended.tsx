...
export type BadgeExtendedVariant = VariantProps<typeof badgeExtendedVariants>["variant"]

export interface BadgeExtendedProps extends React.HTMLAttributes<HTMLDivElement> {
  variant?: BadgeExtendedVariant
}
